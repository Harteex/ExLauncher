...
#ifndef _SCREEN_SETTINGS_SELECT_THEME_H_
#define _SCREEN_SETTINGS_SELECT_THEME_H_
...
class ScreenSettingsSelectTheme : public Screen
{
private:
	View* contentView;
	ISelectionHandler* inputView;

	void AddThemesToList(View* fillView);
	void SetTheme(std::string themeId);
public:
	ScreenSettingsSelectTheme();
	~ScreenSettingsSelectTheme();
